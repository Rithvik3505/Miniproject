...
class DataAnalyzer:
    def __init__(self, root):
        ...
        # Create a DataFrame from your CSV file (replace 'your_data.csv' with your actual file name)
        self.df = pd.read_csv("C:/Users/rithv/WORK/PES/Miniproject/Expenses.csv")
    ...
    def plot_bar_chart(self):
        ...
        ax.bar(self.df['Category'], self.df['Expense amount'])
    ...
    def plot_pie_chart(self):
        ...
        fig = Figure(figsize=(6, 4), dpi=100)
        ax = fig.add_subplot(111)
        ax.pie(self.df['Expense amount'], labels=self.df['Category'], autopct='%1.1f%%', startangle=90)
